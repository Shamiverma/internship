...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {isOpen ? (
        <>
          <div className="absolute top-0 w-full h-screen sm:flex-row flex-col justify-around items-center h-screen sm-1/2 flex bg-white">
          <span onClick={popupMenu}
          className="absolute top-8 right-8 cursor-pointer" >X
          </span>
            <li>Home</li>
            <li>About</li>
            <li>Contact</li>
